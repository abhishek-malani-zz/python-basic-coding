...
for i in range(len(city_list_json)):
    ...
    for j in range(len(countries)):
        ...
        for k in range(len(cities)):
            city_dict = {"range_name": city_list_json[i]['range_name'], "country_name": city_list_json[i]['countries'][j]['country_name'],
                         "city_id": city_list_json[i]['countries'][j]['cities'][k]['city_id'], "city_name": city_list_json[i]['countries'][j]['cities'][k]['city_name']}
